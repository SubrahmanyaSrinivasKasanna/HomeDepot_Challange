...
class ReposInfoViewController: UIViewController, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.repoListTableView.rowHeight = UITableView.automaticDimension
        self.repoListTableView.tableFooterView = UIView()
        
        self.repoGridCollectionView.collectionViewLayout = RepoCollectionLayout()
        self.repoSearchBar.placeholder = "Enter any organization or user name"
    ...
    func retriveRepoList(searchString: String, pageNumber: String){
        ...
        RepoWebserviceManager.getRepoList(url: urlStr.addingPercentEncoding(withAllowedCharacters: CharacterSet.urlQueryAllowed) ?? "", completionHandler: { (repoList:[RepoItem]?, error:Error?) -> Void in
...
extension ReposInfoViewController : UICollectionViewDelegate, UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell{
        ...
        if let licenseName = repo.repoLicense{
            cell.repoLicense.text = licenseName.name ?? nil
        }
        cell.sizeToFit()
        return cell
